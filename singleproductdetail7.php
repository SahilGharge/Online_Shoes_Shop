   ...
   <!----1-->
    <section id="prodetail" class="section-p1">
        <div class="single-product-img">
            <img src="img/shopheaderimg8.jpg" width="100%" id="MainImg" alt="">
            <!---sub img of product first -->
            <div class="small-product-img">
                <div class="small-img-col">
                    <img src="img/shopheaderimg8.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(8.1).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(8.2).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(8.3).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(8.4).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(8.5).png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
