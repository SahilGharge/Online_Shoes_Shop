   ...
   <!----1-->
    <section id="prodetail" class="section-p1">
        <div class="single-product-img">
            <img src="img/shopproductimg3.png" width="100%" id="MainImg" alt="">
            <!---sub img of product first -->
            <div class="small-product-img">
                <div class="small-img-col">
                    <img src="img/shopproductimg3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(3.1).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(3.2).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(3.3).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(3.4).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(3.5).png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="single-product-details">
            <h6>Men's Shoe</h6>
            <h4>Nike Air Force 1 '07 Fresh</h4>
            <h2>MRP : ₹ 11 295.00</h2>
            <select>
