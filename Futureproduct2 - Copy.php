   ...
   <!----1-->
    <section id="prodetail" class="section-p1">
        <div class="single-product-img">
            <img src="img/Futureproduct2.png" width="100%" id="MainImg" alt="">
            <!---sub img of product first -->
            <div class="small-product-img">
                <div class="small-img-col">
                    <img src="img/Futureproduct2.1png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct2.2png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct2.3png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct2.4png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct2.5png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct2.6png.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="single-product-details">
            <h6>Men's Shoe</h6>
            <h4>Nike Pegasus Premium</h4>
            <h2>MRP : ₹ 8 295.00</h2>
            <select>
            ...
            <form action="ordernow.php" method="post">
                <input type='hidden' name="product" value='Nike_Pegasus_Premium'/>
