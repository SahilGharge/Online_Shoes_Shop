   ...
   <!----1-->
    <section id="prodetail" class="section-p1">
        <div class="single-product-img">
            <img src="img/shopheaderimg6.jpg" width="100%" id="MainImg" alt="">
            <!---sub img of product first -->
            <div class="small-product-img">
                <div class="small-img-col">
                    <img src="img/shopheaderimg6.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(6.1).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(6.2).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(6.3).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(6.4).png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/shopimg(6.5).png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
