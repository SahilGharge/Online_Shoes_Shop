   ...
   <!----1-->
    <section id="prodetail" class="section-p1">
        <div class="single-product-img">
            <img src="img/Futureproduct1.png" width="100%" id="MainImg" alt="">
            <!---sub img of product first -->
            <div class="small-product-img">
                <div class="small-img-col">
                    <img src="img/Futureproduct1.1png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct1.2png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct1.3png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct1.4png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct1.5png.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/Futureproduct1.png" width="100%" 
                     class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="single-product-details">
            ...
            <button class="normal" onclick="window.location.href='add_to_cart.php';">Add to Cart</button>
